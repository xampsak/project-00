      ...
      <nav className="bg-white  border-b border-gray-200 shadow-sm">
        <div className="px-6 py-0 flex items-center justify-between">
          ...
          <div className="hidden lg:flex space-x-6 text-sm uppercase font-bold">
            <Link to="/sale-flash" className="hover:text-yellow-500 hover:bg-black py-3 px-2">Flash Sale</Link>
        ...
        {isOpen && (
          <div className="lg:hidden px-6 pb-4 space-y-2 text-sm font-bold uppercase">
            <Link to="/sale-flash" className="block text-black hover:text-yellow-500 hover:bg-black py-3 px-2">Flash Sale</Link>
